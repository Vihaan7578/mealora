  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl max-w-xs sm:max-w-lg lg:max-w-2xl w-full max-h-[90vh] sm:max-h-[80vh] overflow-hidden mx-4 sm:mx-0"
      >
        {/* Header */}
        <div className="bg-gradient-to-r from-primary-500 to-secondary-500 text-white p-4 sm:p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h2 className="text-lg sm:text-xl lg:text-2xl font-bold">Grocery Shopping List</h2>
        ...
        <div className="p-4 sm:p-6">
          {isLoading ? (
            ...
            <>
              <div className="bg-gray-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 max-h-[300px] sm:max-h-[400px] overflow-y-auto mb-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                <motion.button
                  ...
                  className="flex-1 py-3 bg-gradient-to-r from-primary-500 to-secondary-500 text-white font-semibold rounded-lg sm:rounded-xl hover:shadow-lg transition-all flex items-center justify-center gap-2 text-sm sm:text-base"
                >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={onClose}
                  className="px-4 sm:px-6 py-3 bg-gray-200 text-gray-700 font-semibold rounded-lg sm:rounded-xl hover:bg-gray-300 transition-colors text-sm sm:text-base"
                >
                  Close
                </motion.button>
              </div>
